...
import techniquesModule, { techniques as exercises } from './techniques.js';
...
let stateTimeout = {
  state: null,
  startTime: null,
  maxDuration: 1500 // 1.5 seconds — football movements are fast (kicks ~300-500ms)
};
...
function initApp() {
  ...
  // Register football technique phrases
  audioCoach.registerExercisePhrases("Instep Kick", {
    form: ["Lock your ankle and point toes down.", "Drive from the hip for power.", "Follow through toward your target."],
    breathing: ["Exhale as you strike the ball."],
    corrections: { hip: ["Drive more from your hip.", "Open your hip for more power."], knee: ["Snap through the ball.", "Extend your knee on contact."], balance: ["Stay balanced over the ball.", "Keep your body centered."] }
  });
  audioCoach.registerExercisePhrases("Inside Foot Pass", {
    form: ["Turn your foot 90 degrees.", "Push through the ball.", "Keep your body over the ball."],
    breathing: ["Stay relaxed and breathe naturally."],
    corrections: { foot: ["Turn your foot more.", "Use the arch of your foot."], balance: ["Stay centered.", "Don't lean away from the ball."] }
  });
  audioCoach.registerExercisePhrases("Goalkeeper Stance", {
    form: ["Bend your knees more.", "Stay on the balls of your feet.", "Hands up and ready."],
    breathing: ["Keep breathing steadily. Stay alert."],
    corrections: { stance: ["Lower your stance.", "Widen your feet."], balance: ["Lean forward slightly.", "Get your weight forward."] }
  });
  audioCoach.registerExercisePhrases("Outside Foot Pass", {
    form: ["Use the outside of your foot.", "Whip from the knee.", "Disguise your pass."],
    breathing: ["Exhale on contact. Stay relaxed."],
    corrections: { ankle: ["Lock your ankle inward.", "Invert your foot more."], knee: ["Snap from the knee, not the hip.", "Quicker knee whip."], approach: ["Approach at an angle.", "Don't come straight on."] }
  });
  audioCoach.registerExercisePhrases("Heading Technique", {
    form: ["Use your forehead.", "Drive from your core.", "Keep your eyes on the ball."],
    breathing: ["Exhale on contact to brace your neck."],
    corrections: { core: ["Use your core, not your neck.", "Arch your back first."], eyes: ["Keep your eyes open.", "Watch the ball onto your head."], stance: ["Widen your stance.", "Stagger your feet."] }
  });
  audioCoach.registerExercisePhrases("Volley Kick", {
    form: ["Turn sideways to the ball.", "Raise your knee high.", "Lock your ankle."],
    breathing: ["Sharp exhale on the strike."],
    corrections: { timing: ["Wait for the ball to drop.", "Time your swing better."], balance: ["Spread your arms for balance.", "Bend your support leg."], body: ["Turn sideways more.", "Don't face the ball head on."] }
  });
  audioCoach.registerExercisePhrases("Throw-In", {
    form: ["Both hands behind your head.", "Keep both feet down.", "Arch your back for power."],
    breathing: ["Inhale on the arch. Exhale on the throw."],
    corrections: { feet: ["Keep both feet on the ground.", "Don't lift your heel."], arms: ["Equal force with both hands.", "Bring the ball further back."], core: ["Use your core to throw.", "Arch your back more."] }
  });

  // Set Gemini context provider for football techniques
  geminiAPI.setExerciseContextProvider((techniqueName) => {
    const contextMap = {
      "Instep Kick": {
        exerciseContext: "The instep kick uses the laces of the foot for powerful long-range shots and passes. Proper hip drive, ankle lock, and follow-through are essential.",
        formCriteria: "- Plant foot beside the ball, toes at target\n- Drive from the hip, not just the knee\n- Lock ankle, point toes down\n- Strike with the laces\n- Full follow-through toward target",
        commonErrors: "- Toe-poking instead of using laces\n- Planting foot too far from ball\n- Not locking ankle\n- Short follow-through\n- Leaning back (ball goes high)",
        breathingTechnique: "Exhale sharply on contact for power. Breathe naturally during approach."
      },
      "Inside Foot Pass": {
        exerciseContext: "The inside foot pass is the most accurate passing technique, using the arch of the foot. Essential for short to medium range distribution.",
        formCriteria: "- Kicking foot turned 90 degrees outward\n- Strike with the arch\n- Body over the ball\n- Follow through toward target\n- Plant foot beside the ball",
        commonErrors: "- Not turning foot enough\n- Striking with toes\n- Leaning back\n- No follow-through\n- Plant foot too far away",
        breathingTechnique: "Stay relaxed and breathe naturally. Exhale gently on contact."
      },
      "Dribbling Posture": {
        exerciseContext: "Proper dribbling posture maintains a low center of gravity for quick direction changes while keeping the head up for field awareness.",
        formCriteria: "- Knees bent 20-30 degrees\n- Slight forward lean\n- Head up, eyes forward\n- Arms out for balance\n- Light on balls of feet",
        commonErrors: "- Standing too upright\n- Looking down at the ball\n- Stiff legs\n- Arms tight to body\n- Flat-footed",
        breathingTechnique: "Maintain steady breathing. Don't hold your breath during direction changes."
      },
      "Goalkeeper Stance": {
        exerciseContext: "The goalkeeper ready stance optimizes reaction time and explosive movement in any direction. Core position for shot-stopping.",
        formCriteria: "- Feet wider than shoulder-width\n- Knees bent 30-40 degrees\n- Forward lean on balls of feet\n- Hands at waist height\n- Eyes on the ball",
        commonErrors: "- Standing too tall\n- Feet too narrow\n- Weight on heels\n- Hands too low or too high\n- Not staying alert",
        breathingTechnique: "Steady, rhythmic breathing to stay focused. Quick exhale on explosive movements."
      },
      "Outside Foot Pass": {
        exerciseContext: "The outside foot pass is a deceptive technique using the outer edge of the foot. It disguises passing intent and enables quick distribution without opening the body. Requires precise ankle inversion and a whipping knee action.",
        formCriteria: "- Approach at a slight angle (15-30 degrees to ball line)\n- Plant foot slightly behind and to the side of the ball\n- Ankle inverted (turned inward) at contact\n- Whipping motion generated from the knee, not the hip\n- Contact on the outside metatarsal area\n- Follow through across the body",
        commonErrors: "- Approaching too straight-on (no angle)\n- Plant foot too close to the ball (no room for swing)\n- Ankle not locked in inversion (floppy contact)\n- Using hip swing instead of knee snap (loses accuracy)\n- Striking too high on the ball (goes airborne)\n- No follow-through (weak pass)",
        breathingTechnique: "Exhale on contact. Keep upper body relaxed through the whipping motion."
      },
      "Heading Technique": {
        exerciseContext: "Heading uses the forehead to redirect the ball with power generated from the core and back arch, not the neck. Proper timing, eye contact with the ball, and a wide stance are critical for both safety and effectiveness.",
        formCriteria: "- Wide staggered stance (one foot forward) for stability\n- Arch the back to load power before contact\n- Drive forward from the core and torso, not the neck\n- Contact with the flat of the forehead (hairline area)\n- Eyes open and on the ball through contact\n- Arms out for balance, elbows down",
        commonErrors: "- Using the top of the head instead of the forehead\n- Closing eyes before contact (mistiming)\n- Driving from the neck only (injury risk, weak header)\n- Feet together or narrow stance (poor balance)\n- No back arch (no power loading)\n- Jumping with both feet simultaneously (less control)",
        breathingTechnique: "Exhale forcefully on contact to brace the neck and core. Inhale during the back-arch loading phase."
      },
      "Volley Kick": {
        exerciseContext: "The volley strikes the ball out of the air before it bounces. Requires exceptional timing, body positioning (often sideways), and a high knee lift. The kicking motion is a downward-to-forward snap with locked ankle, meeting the ball at its descent.",
        formCriteria: "- Body turned sideways to the ball's flight path\n- Kicking knee raised high (hip at ~90 degrees) before striking\n- Locked ankle with toes pointed down at contact\n- Strike with the laces (instep)\n- Lean back slightly for clearance on high balls\n- Arms spread wide for balance\n- Support leg slightly bent for stability",
        commonErrors: "- Facing the ball head-on instead of sideways (poor power angle)\n- Knee not raised high enough (scooping under the ball)\n- Ankle not locked (inconsistent contact)\n- Swinging too early or too late (mistiming the ball's descent)\n- Leaning too far back (ball goes over)\n- Support leg locked straight (off balance)",
        breathingTechnique: "Sharp exhale on the strike. Stay relaxed during the approach and timing phase."
      },
      "Throw-In": {
        exerciseContext: "The throw-in is the only technique where the ball is delivered by hand. FIFA laws require both feet on the ground, both hands on the ball, and delivery from behind and over the head. Power comes from a back arch and core drive, not just the arms.",
        formCriteria: "- Both hands grip the ball symmetrically behind the head\n- Both feet on or behind the touchline throughout\n- Staggered stance for power (one foot forward)\n- Back arches to load the throw\n- Core drives forward, releasing as ball passes overhead\n- Both arms deliver equal force (asymmetry = foul throw)\n- Follow through with arms toward target",
        commonErrors: "- Lifting a foot off the ground (foul throw)\n- One-handed release or asymmetric force (foul throw)\n- Not bringing ball behind the head (foul throw)\n- No back arch (short throw, arm-only power)\n- Releasing too late (ball goes into ground)\n- Releasing too early (ball goes over target)\n- Spinning or side-stepping (foul throw)",
        breathingTechnique: "Inhale during the back arch. Exhale forcefully during the forward drive and release."
      }
    };
    return contextMap[techniqueName] || {
      exerciseContext: "This football technique requires proper body positioning and controlled movement for effectiveness.",
      formCriteria: "- Maintain proper stance\n- Use controlled movements\n- Keep your balance\n- Follow through properly\n- Stay aware of body position",
      commonErrors: "- Poor balance\n- Insufficient follow-through\n- Wrong body position\n- Not using core\n- Rushing the technique",
      breathingTechnique: "Breathe naturally and exhale during the power phase of the movement."
    };
  });
...
function drawJointAngles(landmarks) {
  ...
  // Football technique angle visualization — lower body focus
  const metricsData = exerciseMetrics[exerciseName];

  // Right hip angle (shoulder-hip-knee)
  if (landmarks[12] && landmarks[24] && landmarks[26]) {
    const rawAngle = calculateAngle(
      { x: landmarks[12].x, y: landmarks[12].y },
      { x: landmarks[24].x, y: landmarks[24].y },
      { x: landmarks[26].x, y: landmarks[26].y }
    );
    angleHistory.rightHip.push(rawAngle);
    if (angleHistory.rightHip.length > 20) angleHistory.rightHip.shift();
    const smoothed = smoothAngleFast(rawAngle, angleHistory.rightHip);
    const idealRange = metricsData?.metricImplementations?.hipMobility?.measure?.(landmarks)?.idealRange || [100, 170];
    drawAngleWithRange(landmarks[24].x, landmarks[24].y, smoothed, idealRange, "R Hip");
  }
  ...
  if (landmarks[24] && landmarks[26] && landmarks[28]) {
    const rawAngle = calculateAngle(
      { x: landmarks[24].x, y: landmarks[24].y },
      { x: landmarks[26].x, y: landmarks[26].y },
      { x: landmarks[28].x, y: landmarks[28].y }
    );
    angleHistory.rightKnee.push(rawAngle);
    if (angleHistory.rightKnee.length > 20) angleHistory.rightKnee.shift();
    const smoothed = smoothAngleFast(rawAngle, angleHistory.rightKnee);
    const idealRange = metricsData?.metricImplementations?.kneeAction?.measure?.(landmarks)?.idealRange || [120, 175];
    drawAngleWithRange(landmarks[26].x, landmarks[26].y, smoothed, idealRange, "R Knee");
  }
  ...
  if (landmarks[11] && landmarks[23] && landmarks[25]) {
    ...
    angleHistory.leftHip.push(rawAngle);
    if (angleHistory.leftHip.length > 20) angleHistory.leftHip.shift();
    const smoothed = smoothAngleFast(rawAngle, angleHistory.leftHip);
    drawAngleWithRange(landmarks[23].x, landmarks[23].y, smoothed, [100, 170], "L Hip");
  }
  ...
  if (landmarks[23] && landmarks[25] && landmarks[27]) {
    ...
    angleHistory.leftKnee.push(rawAngle);
    if (angleHistory.leftKnee.length > 20) angleHistory.leftKnee.shift();
    const smoothed = smoothAngleFast(rawAngle, angleHistory.leftKnee);
    drawAngleWithRange(landmarks[25].x, landmarks[25].y, smoothed, [120, 175], "L Knee");
  }
}
...
function drawRepCountingDebugInfo() {
  ...
  canvasCtx.fillRect(padding, y, 280, 140);
  canvasCtx.fillStyle = '#ffffff';
  ...
  // Draw football-relevant angle info
  let debugLine = 3;
  const debugJoints = [
  ...
  for (const joint of debugJoints) {
    if (angleHistory[joint.key] && angleHistory[joint.key].length > 0) {
      const angle = angleHistory[joint.key][angleHistory[joint.key].length - 1];
      const vel = angularVelocity(angleHistory[joint.key]);
      const angleText = `${joint.label}: ${isNaN(angle) ? "N/A" : Math.round(angle)}° (${Math.round(vel)}°/s)`;
      canvasCtx.strokeText(angleText, padding + 5, y + lineHeight * debugLine);
      canvasCtx.fillText(angleText, padding + 5, y + lineHeight * debugLine);
      debugLine++;
    }
  }
}
    ...
    if (exerciseMetricsData.repCountingStrategy) {
      ...
      if (stateTimeout.state === repState) {
        ...
        if (timeInState > stateTimeout.maxDuration) {
          if (repState === 'waiting') {
            // For football: check hip/knee angles to detect if a technique has started
            let hipAngle = null;
            let kneeAngle = null;
            ...
            console.log(`Forcing transition from waiting. Hip: ${hipAngle?.toFixed(1)}°, Knee: ${kneeAngle?.toFixed(1)}°`);

            // For football kicks: backswing detected by hip flexion or knee bend
            if (hipAngle !== null && hipAngle < 140) {
              repState = 'backswing';
              console.log(`Forced to 'backswing' (hip ${hipAngle.toFixed(1)}°)`);
            } else if (kneeAngle !== null && kneeAngle < 120) {
              repState = 'backswing';
              console.log(`Forced to 'backswing' (knee ${kneeAngle.toFixed(1)}°)`);
            }
          } else {
            // For non-waiting states, reset to waiting
      ...
      if (strategy.transitions && strategy.transitions[repState]) {
        ...
        if (!transitionOccurred && repState === 'waiting' &&
            currentTime - stateTimeout.startTime > 1000) {

          // For football: check hip/knee metrics for technique initiation
          const hipVal = metrics.jointAngles?.hipMobility;
          const kneeVal = metrics.jointAngles?.kneeAction;

          if (hipVal != null && hipVal < 130) {
            repState = 'backswing';
            stateTimeout.state = 'backswing';
            stateTimeout.startTime = currentTime;
            console.log(`Forced to 'backswing' via hip metric (${hipVal.toFixed(1)}°)`);
          } else if (kneeVal != null && kneeVal < 110) {
            repState = 'backswing';
            stateTimeout.state = 'backswing';
            stateTimeout.startTime = currentTime;
            console.log(`Forced to 'backswing' via knee metric (${kneeVal.toFixed(1)}°)`);
          }
        }
      }
    }
...
function calculateMovementDynamics(currentData, historicalData) {
  ...
  // Landmarks to track — lower body focus for football techniques
  const keySets = [
    { name: "rightAnkle", landmark: 28 },
    { name: "leftAnkle", landmark: 27 },
    { name: "rightKnee", landmark: 26 },
    { name: "leftKnee", landmark: 25 },
    { name: "rightHip", landmark: 24 },
    { name: "leftHip", landmark: 23 },
